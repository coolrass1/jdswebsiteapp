...
<section   className={`container relative  imagebox max-w-screen-xl min-w-full  mx-auto md:w-screen 
    h-80  flex   justify-center items-center md:h-screen md:bg-[url("/images/slider3.jpeg")] md:bg-auto md:bg-center`} >
     ...
     <div className='   absolute flex flex-col gap-3  justify-center items-center md:w-full md:h-full md:bg-black/10 md:backdrop-brightness-75'>
