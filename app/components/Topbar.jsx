...
const Topbar = () => {
  ...
  return (
    <header className="container max-w-screen-xl md:mb-7 md:mx-auto h-24 cursor-pointer bg-white flex flex-row items-center justify-between  md:justify-center  ">
          ...
          <li className=" ">
            ...
            <div className="relative [&>*:nth-child(2)]:hover:z-50 [&>*:nth-child(2)]:hover:opacity-100 ">
              ...
              <div className="   opacity-0 min-h-[100px] min-w-[220px] flex flex-col gap-2 justify-start items-center absolute top-14 bg-white">
                <Link className="hover:bg-primary w-full text-center py-4" href="/about">              <span className="text-2xl">Our Company</span>                  </Link>
                <Link className="hover:bg-primary w-full text-center py-4" href="/solicitors">               <span className="text-2xl">Our Solicitors</span>
                </Link>
              </div>
            </div>
      ...
      <nav
        className={`absolute z-10 top-24 left-0 text-white bg-black w-full transition-all ease-in overflow-auto  ${isopen ? " h-80 " : " h-0 overflow-auto"
          }  md:hidden`}
      >
