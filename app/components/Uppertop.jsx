                ...
                <article className='flex justify-center items-start flex-shrink-0'>
                                        <button onClick={() => {
                                            if (typeof window !== 'undefined' && window.matchMedia && window.matchMedia('(max-width: 1023px)').matches) {
                                                window.location.href = 'tel:02073666409'
                                            }
                                        }} className="group uppercase w-full sm:w-auto text-xs lg:text-sm xl:text-base px-6 lg:px-12 xl:px-16 py-2 lg:py-3 xl:py-4 shadow-[0_10px_30px_rgba(216,164,46,0.3)] bg-primary rounded-lg text-secondary font-black hover:bg-secondary hover:text-primary transition-all duration-300 flex items-center gap-3">
