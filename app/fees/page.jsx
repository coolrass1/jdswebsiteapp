...
const Fees = () => {
  const text1 =
    "  Initial consultation taking place during office hours (90 minutes meeting with Solicitor followed by a letter summarising the meeting).";
  ...
  return (
    ...
    <div>
      ...
      >
        <PriceHeader
          title="general"
          price1title="office hour rate"
          price2title="Out of office our rate"
        />
        ...
        <PriceHeader
          ...
          price1title="usual rate"
          price2title="urgent rate"
        />
        ...
        <PriceHeader
          title="Cases with hourly charges"
          price1title="cost excluding VAT"
          price2title=""
        />
        {page22.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ...
        <PriceHeader
          title="legal aid"
          price1title="solicitors"
          price2title="partner"
        />
        {legal_aid.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
        <PriceHeader
          title="family law"
          ...
          price2title="urgent rate"
        />
        {family_law.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
        <PriceHeader
          title="family law (cont'd)"
          price1title="usual rate"
          price2title="urgent rate"
        />
        {family_law_co.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
        ...
        <PriceHeader
          title="purchasing"
          price1title="leasehold"
          price2title="freehold"
        />
        {purchasing.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
        <PriceHeader
          ...
          price2title=""
        />
        {administration.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
        <PriceHeader title="WILLS & PROBATE" price1title="" price2title="" />
        {will_probate.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
        <PriceHeader
          title="WILLS & PROBATE (cont' d)"
          price1title=""
          price2title=""
        />
        {will_probatec.map((p,index) => (
          <PriceElement key={index} title={p.title} text={p.text} p1={p.p1} p2={p.p2} />
        ))}
